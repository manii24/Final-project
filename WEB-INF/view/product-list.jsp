                ...
                <tbody>
                  ...
                  <tr>
                    <td class="product-thumbnail">
                      <img src="/Fashion-Store/prod/getImage/<c:out value='${pd.id}'/>" alt="Image" class="img-fluid">
                    </td>
                    ...
                    <td><a href="/Fashion-Store/prod?id=${pd.id}" class="btn btn-primary btn-sm">Edit</a></td>
                    <td><a href="/Fashion-Store/prod/search?pidd=${pd.id}&operation=Delete" class="btn btn-primary btn-sm">X</a></td>
                  </tr>
