...
@ComponentScan("in.co.fashion.store")
@PropertySource({"classpath:persistence-mysql.properties","classpath:persistence-validation.properties"})
public class FationStoreConfigration implements WebMvcConfigurer {
